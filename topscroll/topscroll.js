...
if (receiver) {
  ...
  receiver.parentElement.setAttribute('style', 'height:' + creativeHeight + 'px;max-height:' + creativeHeight + 'px;');

  //
  receiver.setAttribute('style', 'position:absolute;top:0;left:0;width:100%;height:' + creativeHeight + 'px;clip:rect(auto, auto, auto, auto);z-index:1;');
  ...
  if (iframe) {
    ...
    iframe[0].setAttribute('style', 'position:fixed;width:100%;height:100vh;top:0;left:0;vertical-align:initial;border:0;')
  }
